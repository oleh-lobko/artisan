...
function register_cpt_home() {
    ...
    $args = [
        ...
        'rewrite'            => ['slug' => 'artisan-home'],
    ];
    register_post_type('home', $args);
}
function register_tax_builder() {
    $labels = [
        'name'                       => 'Builders (Company Taxonomy)',
    ...
    $args = [
        ...
        'query_var'         => true,
        'rewrite'           => ['slug' => 'builder-company'],
    ];
    register_taxonomy('builder_tax', ['home'], $args);
}
...
function register_cpt_builder() {
    $labels = [
        'name'          => 'Builders',
        'singular_name' => 'Builder',
        'menu_name'     => 'Builders Team',
    ];
    $args = [
        'labels'             => $labels,
        'public'             => true,
...
add_action('init', 'register_cpt_builder');
add_action('init', 'register_cpt_sponsor');
add_action('init', 'register_tax_builder');
add_action('init', 'register_cpt_home');
